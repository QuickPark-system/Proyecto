...
<nav class="main-header navbar navbar-expand navbar-white navbar-light">
    ...
    <ul class="navbar-nav">
        ...
        <li class="nav-item d-none d-sm-inline-block">
            <!-- <a href="test\servicios.html" class="nav-link">Mapa de Aforos</a> -->
        </li>
    </ul>
...
<aside class="main-sidebar sidebar-dark-primary elevation-4">
    ...
    <a href="<?php echo $URL; ?>/principal.php" class="brand-link">
        <img src="<?php echo $URL;?>public\img\minimalist--futuristic--quickpark-letter.svg.png" alt="AdminLTE Logo" class="brand-image img-circle elevation-3"
             style="opacity: .8">
        <h3><span class="brand-text font-weight-light"><b>QuickPark</b></span></h3>
    </a>
    ...
    <div class="sidebar">
        ...
        <div class="user-panel mt-3 pb-3 mb-3 d-flex">
            <div class="image">
                <img src="<?php echo $URL;?>public\img\free-user-icon-3296-thumb.png" class="img-circle elevation-2" alt="User Image">
            </div>
            <div class="info">
            ...
            <ul class="nav nav-pills nav-sidebar flex-column" data-widget="treeview" role="menu" data-accordion="false">
                ...
                <li class="nav-item has-treeview">
                    ...
                    <ul class="nav nav-treeview">
                        <li class="nav-item">
                            <a href="<?php echo $URL; ?>lista_usuarios.php" class="nav-link ">
                                <i class="far fa-user nav-icon"></i>
                                <p>Listado de Usuarios</p>
                            </a>
                        </li>
                        <li class="nav-item">
                            <a href="<?php echo $URL; ?>crear_usuarios.php" class="nav-link ">
                                <i class="far fa-user nav-icon"></i>
                                <p>Agregar Usuario</p>
                            </a>
                        </li>
                ...
                <li class="nav-item has-treeview">
                    ...
                    <ul class="nav nav-treeview">
                        <li class="nav-item">
                            <a href="<?php echo $URL; ?>servicios/mapa_aforos.php" class="nav-link ">
                                <i class="nav-icon fas fa-car"></i>
                                <p>Mapa de Puestos</p>
                            </a>
                        </li>
